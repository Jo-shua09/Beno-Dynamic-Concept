    ...
    >
      <div className="max-w-[100rem]  mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="text-2xl">Your trusted partner in professional driver outsourcing.</p>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <motion.a whileHover={{ scale: 1.1 }} href="#" className="text-2xl hover:text-blue-400">
              Facebook
            </motion.a>
            <motion.a whileHover={{ scale: 1.1 }} href="#" className="text-2xl hover:text-blue-400">
              Twitter
      ...
      <div className="mt-8 text-center border-t border-gray-700 pt-8">
        <p className="text-2xl">© 2025 Beno Dynamic Concept Nig. All rights reserved.</p>
      </div>
    </motion.footer>
  );
};
