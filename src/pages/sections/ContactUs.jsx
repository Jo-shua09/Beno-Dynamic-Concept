...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:onyekaaigbaze@gmail.com?subject=Contact Form Submission&body=Name: ${formData.fullName}%0D%0AEmail: ${formData.email}%0D%0APhone: ${formData.phone}%0D%0AMessage: ${formData.message}`;
  };
